...
<div class="ref_overview" style="margin-left:10px;background-color:#ddd">
    ...
    <a target="_top" href="func_date_gmstrftime.asp">gmstrftimee()</a>
...
<a class="w3-left w3-btn" href="php_numbers.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="php_constants.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">PHP has a set of math functions that allows you to perform mathematical tasks on numbers.</p>
<hr>

<h2>PHP pi() Function</h2>
<p>The <code class="w3-codespan">pi()</code> function returns the value of PI:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(pi()); // returns 3.1415926535898<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_pi">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>PHP min() and max() Functions</h2>
<p>The <code class="w3-codespan">min()</code> and <code class="w3-codespan">max()</code> functions can be used to find the lowest or highest value in a list of arguments:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(min(0, 150, 30, 20, -8, -200));&nbsp; // returns -200<br>echo(max(0, 
  150, 30, 20, -8, -200));&nbsp; // returns 150<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_min_max">Try it Yourself &raquo;</a>
</div>
<hr>
...
<p>The <code class="w3-codespan">abs()</code> function returns the absolute (positive) value of a number:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(abs(-6.7));&nbsp; // returns 6.7<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_abs">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>PHP sqrt() Function</h2>
<p>The <code class="w3-codespan">sqrt()</code> function returns the square root of a number:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(sqrt(64));&nbsp; // returns 8<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_sqrt">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>PHP round() Function</h2>
<p>The <code class="w3-codespan">round()</code> function rounds a floating-point number 
to its nearest integer:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(round(0.60));&nbsp; // returns 1<br>echo(round(0.49));&nbsp; 
  // returns 0<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_round">Try it Yourself &raquo;</a>
</div>
<hr>

<h2>Random Numbers</h2>
<p>The <code class="w3-codespan">rand()</code> function generates a random number:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(rand());<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_rand">Try it Yourself &raquo;</a>
</div>

<p>To get more control over the random number, you can add the optional <em>min</em> and <em>max</em> parameters to specify the lowest integer and the highest integer to be returned.</p>
<p>For example, if you want a random integer between 10 and 100 (inclusive), use 
<code class="w3-codespan">rand(10, 100)</code>:</p>

<div class="w3-example">
<h3>Example</h3>
<div class="w3-code htmlHigh notranslate">
  &lt;?php<br>echo(rand(10, 100));<br>?&gt;</div>
<a target="_blank" class="w3-btn w3-margin-bottom" href="phptryit.asp?filename=tryphp_math_rand2">Try it Yourself &raquo;</a>
</div>

<hr>

<h2>Complete PHP Math Reference</h2>
<p>For a complete reference of all math functions, go to our complete <a href="php_ref_math.asp">PHP Math Reference</a>.</p>
<p>The PHP math reference contains description and example of use, for each function.</p>
<hr>
